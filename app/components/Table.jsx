...
MoreInfo.propTypes = {
    ...
    forked_count: PropTypes.string.isRequired,
...
function TableRow({ index, owner, stargazers_count, forks, open_issues, name, created_at, updated_at, watchers, language }) {
    ...
    return (
        <tr>
            ...
            <td>
                <Tooltip
                    element={
                        <MoreInfo created_at={created_at} language={language} updated_at={updated_at} watchers={watchers} type={type} login={login} />
                    }>
